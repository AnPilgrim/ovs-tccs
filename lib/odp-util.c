...
odp_action_len(uint16_t type)
{
    ...
    case OVS_ACTION_ATTR_SET_RWND: return sizeof(uint16_t);
                  ...
                  const struct hmap *portno_names)
{
    ...
    case OVS_ACTION_ATTR_SET_RWND: 
        ds_put_format(ds, "setRwnd:%"PRIu16"", nl_attr_get_u16(a));
        break;
                   ...
                   struct ofpbuf *actions)
{
...

    {
        ...
        if (ovs_scan(s, "setRwnd:%"SCNi16"%n", &rwnd, &n)) {
            
            nl_msg_put_u16(actions, OVS_ACTION_ATTR_SET_RWND, rwnd);
            return n;
        }
    }
